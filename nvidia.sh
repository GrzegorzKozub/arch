...
if [[ $HOST == 'player' ]]; then # 5090
  ...
  # 3090 - 2685 - 1
  sudo -E nvidia-settings -a '[gpu:0]/GPUGraphicsClockOffsetAllPerformanceLevels=404'
...
if [[ $HOST == 'worker' ]]; then # 3080
  ...
  sudo -E nvidia-settings -a '[gpu:0]/GPUGraphicsClockOffsetAllPerformanceLevels=100'
