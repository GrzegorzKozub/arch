...
gsettings set org.gnome.shell enabled-extensions "['dim-on-battery@nailfarmer.nailfarmer.com', 'pop-shell@system76.com', 'tray-icons@zhangkaizhao.com', 'user-theme@gnome-shell-extensions.gcampax.github.com']"
