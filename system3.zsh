...
if [[ $MY_DESKTOP = 'GNOME' ]]; then
  ...
  sudo pacman -S --noconfirm \
    ...
    evince gnome-calculator gnome-characters gnome-control-center gnome-font-viewer gnome-remote-desktop gnome-screenshot gnome-system-monitor gnome-terminal gnome-tweak-tool loupe nautilus \
